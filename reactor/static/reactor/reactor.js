...
(function() {
  ...
  reactor_channel.on('message', function({type, id, html_diff, url, action, component_types}) {
    var ref;
    ...
    switch (type) {
      ...
      case 'visit':
        return reactor.visit(url, {
          action: action
        });
      case 'render':
        return (ref = document.getElementById(id)) != null ? typeof ref.apply_diff === "function" ? ref.apply_diff(html_diff) : void 0 : void 0;
      case 'remove':
        return window.requestAnimationFrame(function() {
          var ref1;
          return (ref1 = document.getElementById(id)) != null ? ref1.remove() : void 0;
        });
    }
  });
  ...
  reactor.visit = function(url, options) {
    try {
      switch (options.action) {
        ...
        case 'advance':
          if (typeof Turbo !== "undefined" && Turbo !== null) {
            return Turbo.visit(url, options);
          } else {
